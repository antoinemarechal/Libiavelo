...
public class Repair {
	...
	public void setEndDate(Date endDate) throws InvalidDateException {
		if (this.startDate.after(endDate))
			throw new InvalidDateException("Date de fin des réparations", endDate, "Date de début des réparations", startDate);
		else
	...
	public void setDescription(String description) throws NoDataException {
		if (description.length() == 0) 
			throw new NoDataException("Description du problème");
		else
